...
# look at destination
filter = Filters.new
filter.destinationClean(testConfig[:filter_destination1],testConfig[:filter_destination1A],testConfig[:filter_clean1])

# look at the source
filter.sourceCheck(testConfig[:filter_source1],testConfig[:filter_source1A],testConfig[:filter01],testConfig[:filter_source1B],testConfig[:filter_source1C])
...
windowsJob.jobInfo(b,'MIGRATE',job_number,'Created by Automation - Filter = Exclude Files')
windowsJob.importFile(b,'QA4','QA5','Import File',testConfig[:file_path3])
...
filter.destinationCheckExclude(testConfig[:filter_destination1],testConfig[:filter_destination1A],testConfig[:filter01],testConfig[:filter_destination1B],testConfig[:filter_destination1C])
