...
# look at destination
filter = Filters.new
filter.destinationClean(testConfig[:filter_destination2],testConfig[:filter_destination2A],testConfig[:filter_clean2])

# look at the source
filter.sourceCheck(testConfig[:filter_source2],testConfig[:filter_source2A],testConfig[:filter02],testConfig[:filter_source2B],testConfig[:filter_source2C])
...
windowsJob.jobInfo(b,'MIGRATE',job_number,'Created by Automation - Filter = Include Files')
windowsJob.importFile(b,'QA4','QA5','Import File',testConfig[:file_path4])
...
filter.destinationCheckInclude(testConfig[:filter_destination2],testConfig[:filter_destination2A],testConfig[:filter02],testConfig[:filter_destination2B],testConfig[:filter_destination2C])
