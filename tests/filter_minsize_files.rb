...
# look at destination
filter = Filters.new
filter.destinationClean(testConfig[:filter_destination3],testConfig[:filter_destination3A],testConfig[:filter_clean3])

# look at the source
puts('Testing Min File Size filter...')
filter.sourceCheck(testConfig[:filter_source3],testConfig[:filter_source3A],testConfig[:filter03],testConfig[:filter_source3B],testConfig[:filter_source3C])
...
windowsJob.jobInfo(b,'MIGRATE',job_number,'Created by Automation - Filter = Min File Size (8192 Bytes)')
windowsJob.importFile(b,'QA4','QA5','Import File',testConfig[:file_path5])
...
filter.destinationCheckInclude(testConfig[:filter_destination3],testConfig[:filter_destination3A],testConfig[:filter03],testConfig[:filter_destination3B],testConfig[:filter_destination3C])
