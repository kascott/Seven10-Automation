...
# look at destination
filter = Filters.new
filter.destinationClean(testConfig[:filter_destination4],testConfig[:filter_destination4A],testConfig[:filter_clean4])

# look at the source
puts('Testing Max File Size filter...')
filter.sourceCheck(testConfig[:filter_source4],testConfig[:filter_source4A],testConfig[:filter04],testConfig[:filter_source4B],testConfig[:filter_source4C])
...
filter.destinationCheckExclude(testConfig[:filter_destination4],testConfig[:filter_destination4A],testConfig[:filter04],testConfig[:filter_destination4B],testConfig[:filter_destination4C])
