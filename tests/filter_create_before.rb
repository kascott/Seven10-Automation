...
# look at destination
filter = Filters.new
filter.destinationClean(testConfig[:filter_destination5],testConfig[:filter_destination5A],testConfig[:filter_clean5])

# look at the source
puts('Testing Max File Size filter...')
filter.sourceCheck(testConfig[:filter_source5],testConfig[:filter_source5A],testConfig[:filter05],testConfig[:filter_source5B],testConfig[:filter_source5C])
...
windowsJob.jobInfo(b,'MIGRATE',job_number,'Created by Automation - Filter = Max File Size (16384 Bytes)')
...
filter.destinationCheckExclude(testConfig[:filter_destination5],testConfig[:filter_destination5A],testConfig[:filter04],testConfig[:filter_destination5B],testConfig[:filter_destination5C])
