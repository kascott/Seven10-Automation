...
job_number = 'AUTO-DISCOVERY-Isilon_' + random_string
discoverJob.discoverInfo(b,'DISCOVERY',job_number,'Created by Automation','EMC Isilon')
discoverJob.discoverMC(b,'192.168.23.34','root','Seven10')
...
Watir::Wait.until { b.text.include? 'Shares Discovered' }
